...
# curl -s https://raw.githubusercontent.com/moutazmuhammad/odoo-docker-compose/main/Dockerfile/odoo11/scripts/linux_setup_pg14.sh | bash
...
BASE_DIR="${BASE_DIR:-$PWD/ODOO11_pg14}"
mkdir -p "$BASE_DIR"
VERSIONS=("11")
